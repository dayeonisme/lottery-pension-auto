...
SPREADSHEET_ID = '1LXUJ4So6ZVBFwse5pr0BzQgKgtLbv8Gv2pMLk82Oo5Y'
SCOPES = [
...
# 변경 후
cmd /c "set DHLOTTERY_ID=%DHLOTTERY_ID% && set DHLOTTERY_PW=%DHLOTTERY_PW% && <python-path> <local-lottery-auto-root>\scripts\lotto645_runner.py"
```
